export const INTERACTION_TYPE_CAPS = {
  ONE_TO_ONE: { multipleCoaches: false, multipleParticipants: false },
  ONE_TO_MANY: { multipleCoaches: false, multipleParticipants: true },
  MANY_TO_ONE: { multipleCoaches: true, multipleParticipants: false },
  MANY_TO_MANY: { multipleCoaches: true, multipleParticipants: true },
} as const;
