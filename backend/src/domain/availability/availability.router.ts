...
router
  .route("/weekly")
  .post(
    checkAuth("weekly", "write"),
    validate(SetWeeklyAvailabilitySchema),
    availabilityController.setWeeklyAvailability,
  )
  .get(
    checkAuth("weekly", "read"),
...
router
  .route("/exceptions")
  .post(
    checkAuth("exceptions", "write"),
    validate(AddAvailabilityExceptionSchema),
    availabilityController.addAvailabilityException,
  )
  .get(
    checkAuth("exceptions", "read"),
    validate(UserIdParamSchema),
...
router
  ...
  .delete(
    checkAuth("exceptions", "write"),
    validate(ExceptionIdParamSchema),
...
router
  ...
  .get(
    checkAuth("exceptions", "read"),
    validate(GetEffectiveAvailabilitySchema),
    availabilityController.getEffectiveAvailability,
  )
  .all(methodNotAllowed);
