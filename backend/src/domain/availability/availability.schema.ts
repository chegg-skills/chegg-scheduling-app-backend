...
export const AddAvailabilityExceptionSchema = {
    params: userIdSchema,
    body: AvailabilityExceptionBase.refine(data => {
...
export const AvailabilitySchemas = {
    exception: {
        ...
        partial: AvailabilityExceptionBase.partial().passthrough().refine(validateTimeRange, {
            message: "startTime must be before endTime",
            path: ["endTime"],
        }),
    },
    weekly: {
        ...
        partial: WeeklyAvailabilityBase.partial().passthrough().refine(validateTimeRange, {
            message: "startTime must be before endTime",
            path: ["endTime"],
        }),
    }
