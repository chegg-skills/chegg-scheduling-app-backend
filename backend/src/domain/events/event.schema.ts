...
export const InteractionTypeSchema = {
  body: InteractionTypeBase.refine(
    (data) => {
    ...
    .refine(
      (data) => {
        if (data.maxParticipants != null && data.maxParticipants < data.minParticipants)
          return false;
        return true;
      },
    ...
    .refine(
      ...
      {
        message: "supportsRoundRobin requires supportsMultipleHosts to be true.",
    ...
    .refine(
      ...
      {
        message: "When supportsMultipleHosts is true, maxHosts must be at least 2 or null.",
        path: ["maxHosts"],
      },
    )
    .refine(
      ...
      {
        message: "supportsSimultaneousCoaches requires supportsMultipleHosts to be true.",
