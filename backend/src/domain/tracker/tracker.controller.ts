...
export const getTrackerSlots = asyncHandler(async (req: Request, res: Response) => {
...
export const getSessionDates = asyncHandler(async (req: Request, res: Response) => {
  const caller = res.locals.authUser as CallerContext;
...
export const getTrackerFilters = asyncHandler(async (req: Request, res: Response) => {
  const caller = res.locals.authUser as CallerContext;
