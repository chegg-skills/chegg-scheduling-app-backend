...
export function SlotButton({ slot, isSelected, onClick, timeFormat }: SlotButtonProps) {
  ...
  return (
    ...
    >
      <Typography variant="caption" fontWeight={800} sx={{ color: 'inherit', lineHeight: 1.2 }}>
