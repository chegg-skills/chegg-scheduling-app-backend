  ...
  return (
    <Alert 
      ...
      sx={{
        ...
        border: '1px solid',
        borderColor: (theme) => 
          severity === 'error' ? alpha(theme.palette.error.main, 0.3) :
          severity === 'warning' ? alpha(theme.palette.warning.main, 0.3) :
        ...
        color: (theme) => 
          severity === 'error' ? theme.palette.error.dark :
          severity === 'warning' ? theme.palette.warning.dark :
