...
export function CalendarDayCell({
    ...
    return (
        <Box sx={{
            ...
            '&:hover': {
                bgcolor: isCurrentMonth ? alpha(theme.palette.primary.main, 0.02) : alpha(theme.palette.text.disabled, 0.05),
            }
        }}>
            <Box sx={{
                display: 'flex',
            ...
            <Stack spacing={0.8} sx={{ flexGrow: 1, overflowY: 'auto', maxHeight: { xs: 60, md: 120 } }}>
                ...
                {bookings.length > 4 && (
                    <Typography variant="caption" sx={{ color: 'text.secondary', pl: 1, fontWeight: 700, fontSize: '0.65rem' }}>
