...
const OfferingsPage = lazy(() => import('@/pages/OfferingsPage').then((module) => ({ default: module.OfferingsPage })))
const InteractionTypesPage = lazy(() => import('@/pages/InteractionTypesPage').then((module) => ({ default: module.InteractionTypesPage })))
...
export const router = createBrowserRouter([
  { path: '/login', element: renderLazyPage(LoginPage), errorElement: <RouteErrorPage /> },
  { path: '/register', element: renderLazyPage(RegisterPage), errorElement: <RouteErrorPage /> },
  { path: '/bootstrap', element: renderLazyPage(BootstrapPage), errorElement: <RouteErrorPage /> },
  { path: '/accept-invite', element: renderLazyPage(AcceptInvitePage), errorElement: <RouteErrorPage /> },
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/events/:eventId', element: renderLazyPage(EventDetailPage) },
          { path: '/event-offerings', element: renderLazyPage(OfferingsPage) },
          { path: '/interaction-types', element: renderLazyPage(InteractionTypesPage) },
        ],
      },
    ],
  },
