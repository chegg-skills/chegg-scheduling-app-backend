...
var StepLabel = React2.forwardRef(function StepLabel2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepLabel"
  });
  ...
  const {
    alternativeLabel,
    orientation
  } = React2.useContext(StepperContext_default);
  const {
    active,
    disabled,
    completed,
    icon: iconContext
  } = React2.useContext(StepContext_default);
...
//# sourceMappingURL=chunk-E2HGJQBE.js.map
