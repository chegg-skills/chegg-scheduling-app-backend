...
var OutlinedInput = React.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime2.jsxs)(React.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
  return (0, import_jsx_runtime2.jsx)(InputBase_default, {
    ...
    slotProps,
    renderSuffix: (state) => (0, import_jsx_runtime2.jsx)(NotchedSlot, {
      ...notchedProps,
...
true ? OutlinedInput.propTypes = {
  ...
  slotProps: import_prop_types2.default.shape({
    ...
    notchedOutline: import_prop_types2.default.oneOfType([import_prop_types2.default.func, import_prop_types2.default.object]),
  ...
  slots: import_prop_types2.default.shape({
    input: import_prop_types2.default.elementType,
    notchedOutline: import_prop_types2.default.elementType,
    root: import_prop_types2.default.elementType
  }),
  /**
...
//# sourceMappingURL=chunk-K4FALJIK.js.map
