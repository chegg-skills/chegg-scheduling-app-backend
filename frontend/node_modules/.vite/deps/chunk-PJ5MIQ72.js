...
var NativeSelectInput = React2.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime2.jsxs)(React2.Fragment, {
    children: [(0, import_jsx_runtime2.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime2.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
//# sourceMappingURL=chunk-PJ5MIQ72.js.map
